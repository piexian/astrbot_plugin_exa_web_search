...
- `exa_extract_web_page` — 提取博客/文章的完整内容
...
### 技术博客文章
```
web_search_exa(query="building production LLM applications lessons learned", category="personal site", search_type="deep", max_results=15)
```
...
### 提取文章全文
```
exa_extract_web_page(url="https://example-blog.com/llm-lessons")
```
